...
const StraightCutPage = () => {
  ...
  const fetchProducts = async () => {
    setLoading(true)
    try {
      const response = await fetch('/api/products?category=straight-cut')
      ...
      <div className="category-hero" style={{ background: 'linear-gradient(135deg, var(--primary-gold) 0%, var(--dark-gold) 100%)' }}>
        <div className="category-hero-overlay">
          ...
          >
            ...
            <h1>Straight Cut Suits</h1>
            <p>Classic straight cut suits with modern designs</p>
...
export default StraightCutPage
