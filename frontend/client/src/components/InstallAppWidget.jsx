...
const InstallAppWidget = () => {
  ...
  const handleInstallClick = (targetOS) => {
    ...
    setConfirmModalTarget(targetOS === 'android' ? 'Android' : 'Desktop')
    setIsOpen(false)
  }
  ...
  return (
    <>
              ...
              <div className="popover-os-list">
                ...
                >
                  ...
                  <div className="popover-os-meta">
                    <span className="os-name font-bold">Android Phone / Tablet</span>
                    <span className="os-desc">Chrome & Edge Compatible</span>
                  </div>
                </button>
      ...
      {/* Install Confirmation Modal with Install & Cancel Options */}
      {confirmModalTarget && (
        <div className="ios-install-modal-overlay" onClick={() => setConfirmModalTarget(null)}>
          <div className="install-confirm-modal-card" onClick={(e) => e.stopPropagation()}>
            <button type="button" className="btn-close-modal-x" onClick={() => setConfirmModalTarget(null)}>✕</button>
            
            <div className="install-confirm-header">
              <span className="install-app-icon-badge font-bold">📲</span>
              <h3>Install See Mee Web App</h3>
              <p>Would you like to install See Mee on your <strong>{confirmModalTarget}</strong> device for 1-click access and faster browsing?</p>
            </div>
            ...
            <div className="install-confirm-actions">
              ...
              <button 
                type="button" 
                className="btn-modal-install-now" 
