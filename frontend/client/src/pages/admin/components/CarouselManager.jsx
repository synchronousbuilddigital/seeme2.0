...
const CarouselManager = () => {
  ...
  const handleProductSelect = (productId) => {
    ...
    setFormData(prev => ({
      ...prev,
      image: productImage || prev.image,
      productId,
      productName: product?.name || '',
      productCategory: product?.category || '',
      title: product?.name || prev.title,
      subtitle: product?.category || prev.subtitle
    }))
  }
  ...
  const startEdit = (image) => {
    ...
    setSelectedProductId(image.productId || '')
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              <label htmlFor="carousel-product">Select Product</label>
              <select
                id="carousel-product"
                value={selectedProductId}
                onChange={(e) => handleProductSelect(e.target.value)}
              >
                <option value="">-- Choose a product or keep manual image --</option>
              ...
              <small className="form-hint">
                Picking a product auto-fills the hero image, title, and subtitle from the first product image.
              </small>
            </div>
          ...
          {carouselImages.map((image) => (
            ...
            >
              ...
              <div className="carousel-info">
                ...
                {image.productName && (
                  <p className="subtitle">Product: {image.productName}</p>
                )}
